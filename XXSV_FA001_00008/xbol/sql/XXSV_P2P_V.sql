/* Formatted on 10/17/2014 11:07:18 AM (QP5 v5.139.911.3011) */
...
SELECT ph.org_id
      ...
      ,ph.vendor_site_id
                    ,h.NAME operating_unit,
                     ...
                     --     , aia.invoice_id  ,fai.date_effective  /* HiPr */,
--                     fa.asset_type /* HiPr */,
--                     fab.date_placed_in_service /* HiPr */,
  ...
  --                                          (pd.po_distribution_id)
  --                                                                 monto_pagado
  FROM bolinf.Xxsv_Hr_Operating_Units h
 ...
 WHERE h.organization_id IN (345, 347)
   AND h.organization_id = ph.org_id
